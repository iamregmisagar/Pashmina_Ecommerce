...
export default function SignInComponent({modeTool}) {
  return (
    ...
    <div className= "body-font relative grid justify-center ">
        ...
        <button className={`${modeTool.darkMode?"bg-emerald-800 hover:bg-emerald-950": "bg-green-500 hover:bg-green-600"} mt-6 text-white  border-0 py-2 px-8 text-lg focus:outline-none  rounded`}>Sign In</button>
        <p className="text-xs mt-3">Sign in today and enjoy our products. You won't regret it! </p>
      </div>  
      </div> 
  )
}